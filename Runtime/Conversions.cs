...
public static class Conversions
{
    ...
    public static Vector3Int ToUnity(this Int3 value) => new Vector3Int(value.X, value.Y, value.Y);
    ...
    public static Int3 ToZero(this Vector3Int value) => new Int3(value.x, value.y, value.y);
